...
from flask import _app_ctx_stack as app_ctx  # Alteração nesta linha
...
def _app_ctx_id() -> int:
    ...
    ctx = app_ctx.top  # Alteração nesta linha
    if ctx is not None:
        return id(ctx)
    raise RuntimeError("No application context found. This function should be called within a Flask request context.")
